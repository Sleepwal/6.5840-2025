...
//
// If the versions numbers don't match, the server should return ErrVersion.
...
//
// If the server returns ErrVersion on a resend RPC, then Put must return ErrMaybe to the application, since
// its earlier RPC might have been processed by the server successfully
// but the response was lost, and the Clerk doesn't know if the Put was performed or not.
//
// You can send an RPC with code like this:
